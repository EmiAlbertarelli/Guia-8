...
d)Método obtenerRaices(): llama a tieneRaices() y si devolvió true, imprime las
2 posibles soluciones.
e)Método obtenerRaiz(): llama a tieneRaiz() y si devolvió true imprime una única 
raíz. Es en el caso en que se tenga una única solución posible.
f)Método calcular(): este método llamara tieneRaices() y a tieneRaiz(), y 
...
signo delante de -b*/
package ejercicioextr1g8;

import entidades.Raiz;
import servicios.RaizServicio;


public class EjercicioExtr1G8 {
